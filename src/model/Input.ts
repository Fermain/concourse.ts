...
import { Input as InputData } from '../types/input.js'
import ConcourseClient from '../Client.js' // Use default import, ADDED .js

// Keeping the factory function pattern, but typed
export const toInput = (client: ConcourseClient) => (inputData: InputData):
  Input => new Input({ ...inputData, client })
...
export default class Input {
  ...
  constructor ({ name, resource, passed, trigger, version, params, client }: InputConstructorParams) {
